...
export interface ApiAttractionAttraction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    city_es: Schema.Attribute.String;
    city_zh: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    location_es: Schema.Attribute.Text;
    location_zh: Schema.Attribute.Text;
    name_en: Schema.Attribute.String;
    name_es: Schema.Attribute.String;
    name_zh: Schema.Attribute.String & Schema.Attribute.Required;
    opening_hours_en: Schema.Attribute.String;
    opening_hours_es: Schema.Attribute.String;
    opening_hours_zh: Schema.Attribute.String;
    province_en: Schema.Attribute.String;
    province_es: Schema.Attribute.String;
    province_zh: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    reservation_required: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    sort_order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    ticket_price_en: Schema.Attribute.String;
    ticket_price_es: Schema.Attribute.String;
    ticket_price_zh: Schema.Attribute.String;
    tips_en: Schema.Attribute.Text;
    tips_es: Schema.Attribute.Text;
    tips_zh: Schema.Attribute.Text;
    transport_en: Schema.Attribute.Text;
    transport_es: Schema.Attribute.Text;
    transport_zh: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    people_count: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
...
export interface ApiDestinationDestination extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    content_es: Schema.Attribute.Text;
    content_zh: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dest_value: Schema.Attribute.String;
    image: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiInquiryInquiry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    phone: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['pending', 'processing', 'done']> &
      Schema.Attribute.DefaultTo<'pending'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMomentMoment extends Struct.CollectionTypeSchema {
  collectionName: 'moments';
  info: {
    displayName: 'Moment \u65C5\u9014\u77AC\u95F4';
    pluralName: 'moments';
    singularName: 'moment';
  };
  options: {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    sort_order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    taken_at: Schema.Attribute.Date;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiNoticeNotice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    qr_img: Schema.Attribute.Media<'images'>;
    sort_order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    avatar_char: Schema.Attribute.String;
    ...
    tour_label_en: Schema.Attribute.String;
    tour_label_es: Schema.Attribute.String;
    tour_label_zh: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    highlights_en: Schema.Attribute.JSON;
    highlights_es: Schema.Attribute.JSON;
    highlights_zh: Schema.Attribute.JSON;
    image: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    route_en: Schema.Attribute.String;
    route_es: Schema.Attribute.String;
    route_zh: Schema.Attribute.String;
    sort_order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    title_en: Schema.Attribute.String;
    title_es: Schema.Attribute.String;
    title_zh: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
